...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                // loader: () => fetch('https://toy-world.vercel.app/allToys')
            },
            {
                path: '/details/:id',
                element: <PrivateRoute><Details></Details></PrivateRoute>,
                loader: ({ params }) => fetch(`https://toy-world.vercel.app/allToys/${params.id}`)
            },
            {
                path: '/addToy',
            ...
            },
            {
                ...
                loader:({params})=>fetch(`https://toy-world.vercel.app/editToys/${params.id}`)
            },
            // },
            {
                path: '/myToys',
                element:<PrivateRoute><MyToys></MyToys></PrivateRoute>,
                // loader: ({ params }) => fetch(`https://toy-world.vercel.app/myToys/${params.email}`)
            },
            {
                path: '/blogs',
                element:<Blogs></Blogs>
