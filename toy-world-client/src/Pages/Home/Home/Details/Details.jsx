...
const Details = () => {
    ...
    return (
        <div className="text-center justify-center items-center ">
            ...
            <div className=" w-98 bg-black border border-pink-400 text-center py-8 px-24 text-pink-200 shadow-xl items-center">
            ...
            <img className="w-full" src="../../../../../assets/banner/illustration-city-anime-painting-wallpaper-thumb.jpg" alt="" />
        </div>
    );
};
