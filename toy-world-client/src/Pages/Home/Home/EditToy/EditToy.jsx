...
const EdiToy = () => {
  ...
  const handleUpdate =event =>{
    ...
    fetch(`https://toy-world.vercel.app/allToys/${data._id}`,{
      method:"PUT",
      headers:{
  ...
  return (
    <div>
      ...
      <div className="grid grid-flow-col justify-around m-3">
        <img className="w-16 items-center justify-center text-center" src="https://i.ibb.co/dmtMsJz/3082060.png" alt="" />
        <img className="w-16 items-center justify-center text-center" src="https://i.ibb.co/dmtMsJz/3082060.png" alt="" />
        <img className="w-16 items-center justify-center text-center" src="https://i.ibb.co/dmtMsJz/3082060.png" alt="" />
        <img className="w-16 items-center justify-center text-center" src="https://i.ibb.co/dmtMsJz/3082060.png" alt="" />
        <img className="w-16 items-center justify-center text-center" src="https://i.ibb.co/dmtMsJz/3082060.png" alt="" />
