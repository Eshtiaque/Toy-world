...
const Blogs = () => {
    ...
    return (
        <div>
            <div>
                <h1 className="text-center m-2 bg-black text-pink-300 p-4 font-black text-4xl rounded-full">* Blogs *</h1>
            </div>
            <div className="bg-black border rounded-3xl">

                <div className="text-2xl text-slate-300 rounded-full lg:p-20 md:p-15 p-10">
                    <h1 className="font-black"><strong className="text-pink-300">Question 01 : </strong>What is an access token and refresh token? How do they work and where should we store them on the client-side?</h1>
                    <p><strong className="text-pink-300">Ans:</strong><br /><strong className="underline underline-offset-8">Access Token : </strong>
            ...
            <div className="bg-black border rounded-3xl">
                ...
                <div className="text-2xl text-slate-300 rounded-full lg:p-20 md:p-15 p-10">
                    <h1 className="font-black"><strong className="text-pink-300">Question 02 : </strong>Compare SQL and NoSQL databases?</h1>
                    <p><strong className="text-pink-300">Ans:</strong><br /><strong className="underline underline-offset-8">SQL : </strong>
            ...
            <div className="bg-black border rounded-3xl">
                ...
                <div className="text-2xl text-slate-300 rounded-full lg:p-20 md:p-15 p-10">
                    <h1 className="font-black"><strong className="text-pink-300">Question 03 : </strong>What is express js? What is Nest JS?</h1>
                    <p><strong className="text-pink-300">Ans:</strong><br /><strong className="underline underline-offset-8">Express.js : </strong>
            ...
            <div className="bg-black border rounded-3xl">
                ...
                <div className="text-2xl text-slate-300 rounded-full lg:p-20 md:p-15 p-10">
                    <h1 className="font-black"><strong className="text-pink-300">Question 04 : </strong>What is MongoDB aggregate and how does it work (google it)?</h1>
                    <p><strong className="text-pink-300">Ans:</strong><br /><strong className="underline underline-offset-8">MongoDB aggregate : </strong>
