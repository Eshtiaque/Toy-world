...
const Login = () => {
    ...
    return (
        <div className="hero min-h-screen bg-base-200 text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
                    ...
                    <div className="card-body">
                        ...
                        <form onSubmit={handleLogin} >
                            ...
                            <div className="form-control mt-6">
                                <button className="btn  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white" type='submit' value="Login">Login</button>
                            </div>
                            <div className="form-control mt-6">
                                <button onClick={handleGoogleSignIn} className="btn  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white" type='submit' value="Login"><span className="mr-2 bg-white rounded-full p-1"><FcGoogle /></span> Google</button>
                            </div>
                        </form>

                        <p className='my-4 text-center text-white'>New Member ?  ::  <Link className="text-secondary font-bold" to="/signUp">Sign Up</Link></p>
